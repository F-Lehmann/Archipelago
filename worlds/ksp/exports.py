...
if __name__ == "__main__":
    ...
    from worlds.KerbalSpaceProgram.locations import Vector, location_table
    from worlds.KerbalSpaceProgram.items import item_table, group_items, items_by_type
    from NetUtils import encode

    export_folder = os.path.join(new_home, "KerbalSpaceProgram Export")
    ...
    print(f"KerbalSpaceProgram exports dumped to {in_export_folder('')}")
